...
<section class="background-removal">
    <div class="main">
                ...
                <form id="uploadForm" action="{{ route('/backgroundchange') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-content">
                        <label class="custom-file-upload" for="imgInp">
                            ...
                            <input type="hidden" id="tool_id" name="tool_id" value="4">
                        ...
                        <label for="prompt">choice a Background:</label>
        ...
        @elseif(session('Generated_background_1'))
            <div class="image_url">
                <div class="form-content" id="image_url">
                    <img src="{{ session('Generated_background_1') }}" alt="Processed Image">
                    <a id="download" href="{{ session('Generated_background_1') }}" download>Click here to Download image</a>
                    <img src="{{ session('Generated_background_2') }}" alt="Processed Image">
                    <a id="download" href="{{ session('Generated_background_2') }}" download>Click here to Download image</a>
                </div>
            </div>
        @endif
    </div>
